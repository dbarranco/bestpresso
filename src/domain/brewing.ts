...
export type EditableMachineSetting = 'hotWaterVolume' | 'hotWaterTemperature' | 'steamTemperature' | 'steamDuration' | 'steamFlow' | 'flushTemp' | 'flushTimeout' | 'flushFlow' | 'fan' | 'heaterVoltage' | 'flowMultiplier' | 'steamPurgeMode' | 'heaterPh1Flow' | 'heaterPh2Flow' | 'heaterIdleTemp' | 'heaterPh2Timeout' | 'cupWarmerTemperature' | 'cupWarmerLeadMinutes'
